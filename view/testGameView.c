...
int main(void)
{
	...
	{///////////////////////////////////////////////////////////////////
		...
		assert(GvGetHealth(gv, 1) == GAME_START_HUNTER_LIFE_POINTS);
	...
	{///////////////////////////////////////////////////////////////////
		...
		assert(GvGetHealth(gv,PLAYER_DRACULA) == GAME_START_BLOOD_POINTS - 20 - 2);
		assert(GvGetScore(gv) == GAME_START_SCORE - 11);
	...
	{///////////////////////////////////////////////////////////////////
		...
		char *trail =
			...
			int numMoves = 0;
			bool canFree = false;		
			PlaceId *lastMove = GvGetLastMoves(gv, PLAYER_DRACULA,1,&numMoves,&canFree);
			assert(numMoves > 0);
			printf("Current DRACULA Location %d\n", lastMove[0]);
			assert(lastMove[0] == TELEPORT);
			PlaceId his[TRAIL_SIZE];
			GvGetTrailHistory(gv, PLAYER_DRACULA, his);
			assert(his[0] == TELEPORT);
			assert(his[1] == DOUBLE_BACK_3);
			assert(his[2] == HIDE);
			assert(his[3] == PRAGUE);
			assert(his[4] == BERLIN);
			assert(his[5] == LEIPZIG);

			if (canFree) free(lastMove);
			GvFree(gv);
			printf("Test passed!\n");
	}
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing a vampire maturing - case 2\n");
		
		char *trail =
		"GED.... SGE.... HZU.... MCA.... DC?.V.. " 
		"GMN.... SCF.... HGE.... MLS.... DC?T... "  
		"GLO.... SMR.... HCF.... MMA.... DC?T... "  
		"GPL.... SMS.... HMR.... MGR.... DC?T... "  
		"GEC.... SBA.... HGO.... MAL.... DC?T... "  
		"GLE.... SZA.... HTS.... MMS.... DC?T... "  
		"GPA.... SVI.... HIO.... MCG.... DC?T.V.";	
		...
		assert(GvGetHealth(gv,PLAYER_DR_SEWARD) == 9);
		assert(GvGetScore(gv) == GAME_START_SCORE - 7 - 13);
